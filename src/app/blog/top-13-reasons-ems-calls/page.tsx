        ...
        <article className="prose prose-lg max-w-none">
          ...
          <div className="space-y-4 mb-8">
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">1. Chest Pain and Heart Problems</h3>
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">2. Difficulty Breathing</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">3. Falls and Fall-Related Injuries</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">4. Motor Vehicle Accidents</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">5. Stroke Symptoms</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">6. Unconsciousness or Altered Mental Status</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">7. Severe Abdominal Pain</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">8. Seizures</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">9. Severe Bleeding</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">10. Drug Overdose or Poisoning</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">11. Severe Allergic Reactions</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">12. Diabetic Emergencies</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
            ...
            <div className="border-l-4 border-[#245789] pl-4">
              <h3 className="text-lg font-bold text-[#245789] mb-2">13. Behavioral or Psychiatric Emergencies</h3>
              <p className="text-gray-700 leading-relaxed text-sm">
          ...
          <div className="bg-[#245789] text-white p-6 rounded-lg mt-8">
            <h3 className="text-xl font-bold mb-3">Be Prepared for Any Emergency</h3>
              ...
              <div className="border rounded-lg overflow-hidden">
                <div className="md:flex">
                  ...
                  <div className="md:w-2/3 p-4">
                    ...
                    <h3 className="text-lg font-bold text-[#245789] mb-2">
