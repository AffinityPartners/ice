...
function FeatureCard({ icon, title, description, delay = 0 }: FeatureCardProps) {
  ...
  return (
    <motion.div
      ...
      transition={{ delay }}
    >
      <Card interactive className="h-full p-6 text-center group">
...
function PlanCard({ name, price, profiles, features, highlighted = false }: PlanCardProps) {
  return (
    <Card 
      interactive 
      className={`h-full ${highlighted ? 'ring-2 ring-[#CA0015] bg-gradient-to-br from-[#245789] to-blue-700 text-white' : ''}`}
    >
